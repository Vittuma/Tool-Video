...
class VideoTranslator:
    ...
    async def process_video(self, input_path, output_path, target_lang="vi", voice="vi-VN-HoaiMyNeural"):
        # 1. Load Video
        ...
        # Whisper.transcribe is synchronous, we run it in a thread if needed, but for simplicity:
...
if __name__ == "__main__":
    ...
    if not os.path.exists(args.input):
        ...
        asyncio.run(translator.process_video(args.input, args.output, args.lang, args.voice))
